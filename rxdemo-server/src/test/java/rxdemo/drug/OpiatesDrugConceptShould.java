...
public class OpiatesDrugConceptShould {
   ...
   public void identifyDrugInConcept() {
      DispensableDrug drug = new DispensableDrug(1, "diazepam", EDrugClassification.ANTIANXIETY);
      Assert.assertTrue(OpiatesDrugConcept.isDrugInConcept(drug));
   }

   @Test
   public void identifiesDrugInConceptWhenDrugHasMultipleClasses() {
      DispensableDrug drug = new DispensableDrug(1, "fake drug", EDrugClassification.ANTIBACTERIAL,
   ...
   public void rejectDrugNotInConcept() {
      DispensableDrug drug = new DispensableDrug(1, "fluticasone", EDrugClassification.NASAL_CORTICOSTEROIDS);
